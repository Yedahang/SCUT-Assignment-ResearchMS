...
function handle(){
	...
	$("button[event=upd]").on("click", (e)=>{
        ...
        $.ajax({
            url: "/researchMS/organizations/info/",
            type: "GET",
            async: false,
            data:{
    ...
    $("button[event=del]").on("click", (e)=>{
        ...
        $.confirm("确认要删除吗", () =>{
            ...
            $.ajax({
                url: "/researchMS/organizations/del/",
                type: "POST",
                async: false,
                data:{
                    id: $(e.target).attr("data"),
...
$(function (){
    ...
    let tableView =  {
        el: "#tableShow",
        url: "/researchMS/organizations/page/",
        method: "GET",
        where: {
            pageIndex: 1,
            pageSize: 10
    ...
    $("#addFormBtn").on("click", ()=>{
        ...
        $.ajax({
            url: "/researchMS/organizations/add/",
            type: "POST",
            data: formData,
    ...
    $("#updFormBtn").on("click", ()=>{
        ...
        let formData = new FormData(formElement);
        $.ajax({
            url: "/researchMS/organizations/upd/",
            type: "POST",
            data: formData,
            processData: false,// 禁止将数据处理为查询字符串
            contentType: false, // 禁止设置Content-Type头部
