function handle(){
	...
	$("button[event=upd]").on("click", (e)=>{
        ...
        $.ajax({
            url: "/researchMS/educationLogs/info/",
            type: "GET",
            async: false,
            data:{
    ...
    $("button[event=del]").on("click", (e)=>{
        ...
        $.confirm("确认要删除吗", () =>{
            ...
            $.ajax({
                url: "/researchMS/educationLogs/del/",
                type: "POST",
                async: false,
                data:{
                    id: $(e.target).attr("data"),
...
$(function (){
    ...
    let tableView =  {
        el: "#tableShow",
        url: "/researchMS/educationLogs/page/",
        method: "GET",
        where: {
            pageIndex: 1,
            pageSize: 10
    ...
    $("#addFormBtn").on("click", ()=>{
        ...
        $.ajax({
            url: "/researchMS/educationLogs/add/",
            type: "POST",
            data: formVal,
            success: function(res){
                if(res.code == 0){
    ...
    $("#updFormBtn").on("click", ()=>{
        ...
        $.ajax({
            url: "/researchMS/educationLogs/upd/",
            type: "POST",
            data: formVal,
            success: function(res){
                if(res.code == 0){
