function handle(){
	...
	$("button[event=upd]").on("click", (e)=>{
        ...
        $.ajax({
            url: "/researchMS/achievements/info/",
            type: "GET",
            async: false,
            data:{
    ...
    $("button[event=del]").on("click", (e)=>{
        ...
        $.confirm("确认要删除吗", () =>{
            ...
            $.ajax({
                url: "/researchMS/achievements/del/",
                type: "POST",
                async: false,
                data:{
                    id: $(e.target).attr("data"),
    ...
    $("button[event=cancel]").on("click", (e)=>{
        ...
        $.ajax({
            url: "/researchMS/achievements/upd/",
            type: "POST",
            async: false,
            data:{
                id: $(e.target).attr("data"),
...
$(function (){
    ...
    let tableView =  {
        el: "#tableShow",
        url: "/researchMS/achievements/page/",
        method: "GET",
        where: {
            pageIndex: 1,
            pageSize: 10
    ...
    $(".fater-btn-form-qry").on("click", ()=>{
        ...
        tableView.where["achievement_name"] = $("[name=para1]").val();
    ...
    $("#addFormBtn").on("click", ()=>{
        ...
        $.ajax({
            url: "/researchMS/achievements/add/",
            type: "POST",
            data: formData,
